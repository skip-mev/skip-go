...
## Why am I getting a CORS error or blocked by CORS policy?

If you're seeing CORS errors when using the Skip Go widget, it means your domain needs to be whitelisted to access Skip Go's API endpoints.
