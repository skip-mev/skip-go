...
<<<<<<< chore/upd-go-widget-docs
`defaultRoute` allows you to customize the first route that appears on the widget on page load. Use this to direct your users to the most important route you expect them to be interested in when they arrive to your dApp. 
You can query supported assets using the Skip Go API `/assets` [endpoint](https://docs.skip.build/go/api-reference/prod/fungible/get-v2fungibleassets).
=======
