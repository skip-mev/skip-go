...
- **`setClientOptions(options)`:** Use this if you plan to use `executeRoute` or interact directly with blockchains. It configures your API credentials and lets you provide chain-specific settings like endpoints, Amino types, and registry types.
