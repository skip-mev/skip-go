...
- **`setApiOptions(options)`:** Use this if you primarily need to configure API interaction (`apiUrl`, `apiKey`). This option does not configure `endpointOptions`, `aminoTypes`, or `registryTypes`.
