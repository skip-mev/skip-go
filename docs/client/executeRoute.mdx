...
The executeRoute function is the core entry point for executing a route, including optional support for simulating transactions, injecting custom Cosmos messages, and tracking transaction status.
