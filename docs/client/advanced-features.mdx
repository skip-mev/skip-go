...
When initializing your client, specify the `goFast` boolean in the `routeConfig` prop. If a route is eligible for Go Fast, the API will return it in the transfer operations.
