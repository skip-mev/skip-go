---
title: "Eureka CLI Devnet Testing Guide"
id: eureka-cli
...
- An ERC20 token on Ethereum Sepolia Testnet such as our [$TNERC](https://sepolia.etherscan.io/token/0xa4ff49eb6e2ea77d7d8091f1501385078642603f)
...
## Relay the Transaction: Ethereum->Cosmos
...
### Relay the Transaction: Cosmos->Ethereum
