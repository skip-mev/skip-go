...
If you're an asset issuer aiming to expand your token's reach across blockchains connected to the Eureka ecosystem, the recommended path is to deploy a custom ERC20 contract on Ethereum. This ensures you have full control over your token's representation.

### Custom ERC20 Integration

We support custom ERC20 contracts for asset issuers who want complete ownership of their token's representation on Ethereum. This allows you to:
...
Learn more about deploying and registering custom ERC20 contracts in our [Custom ERC20 Integration Guide](/eureka/custom-erc20-integration).
