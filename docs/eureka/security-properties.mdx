...
- migrating light clients in case of failure, expiration or security vulnerabilities/incidents
- designating specific canonical names for IBC applications on Ethereum mainnet
...
The council is composed of Interchain Labs employees who are going to be responding to security incidents related to canonical IBC Eureka deployments. The actions of the pausing council are not time-locked
...
This means that the security council will be much be closer to becoming obsolete, while allowing the Cosmos Hub to override actions taken by the security council.
