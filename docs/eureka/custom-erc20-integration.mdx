...
<CardGroup cols={2}>
  ...
  <Card title="Improved CEX Listing" icon="bank">
...
<Steps>
  ...
  <Step title="Verify and Launch">
    Verify your contract on Etherscan to build trust with users. For guidance, refer to the [Etherscan Contract Verification Guide](https://support.etherscan.io/hc/en-us/articles/360061962991-Contract-Verification-Overview). Then, begin bridging your token with full control over its ERC20 representation.
  </Step>
</Steps>
...
- Learn about [Etherscan contract verification](https://support.etherscan.io/hc/en-us/articles/360061962991-Contract-Verification-Overview) to enhance trust in your token 