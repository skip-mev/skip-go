...
<Steps>
  ...
  <Step title="Verify and Launch">
    Verify your contract on Etherscan to build trust with users. For guidance, refer to the [Etherscan Contract Verification page](https://etherscan.io/verifyContract). Then, begin bridging your token with full control over its ERC20 representation.
  </Step>
</Steps>
