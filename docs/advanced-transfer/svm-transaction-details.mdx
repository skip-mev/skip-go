...
description: "This document explains how to use Skip Go API and Core TypeScript Package to construct SVM transactions."
---
...
[Skip Go Core](https://www.npmjs.com/package/@skip-go/core) takes care of all of the complexity of signing the transaction that gets returned in `SvmTx.tx`. 
