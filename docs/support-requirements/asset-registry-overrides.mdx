...
To resolve these issues and give teams control over how their assets appear across all Skip Go, we can override these with the **[Skip Go Asset Registry](https://github.com/skip-mev/skip-go-registry)**.
...
- Fix decimals issues with you assets
...
- **Size**: Minimum 250x256px for PNG, vector for SVG
