...
<Info>
  Want to dive deeper? See the [detailed walkthrough](../client/getting-started) that includes Solana and EVM transactions.
</Info>

## Prerequisites

- **Node.js** and **npm** 
- Browser environment setup (`create-next-app` is recommended) with **Keplr** installed
