 ...
 **Activate Smart Relay (`smart_relay=true`) for global coverage of all chains, bridges, and routes**
 ...
 As a result, if you want your users to be able to transfer their tokens over all routes, we recommend using Smart Relay. Read more about [Smart Relay](/smart-relay).
</Info>
