...
* [Eureka](https://docs.skip.build/go/eureka/eureka-overview): IBC v2 that enables seamless interoperability between Cosmos and Ethereum ecosystem. Uses Succinct's SP1 zero-knowledge proofs for gas-efficient verification of Cosmos state on Ethereum
