...
#### Can I use Safe Multisig wallets with Skip Go?

Yes! Safe wallets (the popular multisig wallet at https://app.safe.global) can be used with Skip Go through wallet providers that support importing Safe wallets:
...
Both options allow you to use your Safe wallet for multi-chain swaps and transfers through Skip Go.
