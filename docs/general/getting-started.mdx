 ...
 **What does it cost?**
 ...
 The Skip Go API is free to use and integrate with. You will have very limited access if you do not have an API key from us. Please join our Discord and request one: [https://skip.build/discord](https://skip.build/discord)
</Info>
...
1. **Most control, slowest:** Use REST endpoints to have low-level control over your interactions
2. **High control, medium speed:** Use the [Skip Go Client](/client/getting-started) Typescript Package (`@skip-go/client`) to abstract the complexity of making HTTP calls and access related helper functionality. 
