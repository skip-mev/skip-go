...
<CardGroup cols={3}>
  <Card title="Rest Endpoint — Most control, slowest" icon="sliders" href="/general/overview-and-typical-usage">
    Use REST endpoints for low-level control over your interactions.
  </Card>
  <Card title="Client Library — High control, fast" icon="code" href="/client/getting-started" >
    Use the TypeScript library to abstract the complexity of making HTTP calls and access related helper functionality. 
  </Card>
  <Card title="Swap Widget — Medium control, fastest" icon="bolt-lightning" href="/widget/getting-started" >
    Embed the Skip Go SwapWidget in your frontend in a single line of code to launch with no developer effort.
  </Card>
</CardGroup>
