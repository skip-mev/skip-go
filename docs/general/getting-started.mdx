...
2. **High control, medium speed:** Install and use Skip Go Client, our Typescript Package (`@skip-go/client`) to abstract the complexity of making HTTP calls and access related helper functionality (e.g. for generating and signing transactions, awaiting changes in transaction status, etc...)
