...
export interface SignatureThresholdUpdatedSDKType {
  old_signature_threshold: Long;
  new_signature_threshold: Long;
}
/**
...
export interface MaxMessageBodySizeUpdatedSDKType {
  new_max_message_body_size: Long;
}
/**
...
function createBaseSignatureThresholdUpdated(): SignatureThresholdUpdated {
  return {
    oldSignatureThreshold: Long.UZERO,
    newSignatureThreshold: Long.UZERO
  };
}
export const SignatureThresholdUpdated = {
  ...
  fromJSON(object: any): SignatureThresholdUpdated {
    return {
      oldSignatureThreshold: isSet(object.oldSignatureThreshold) ? Long.fromValue(object.oldSignatureThreshold) : Long.UZERO,
      newSignatureThreshold: isSet(object.newSignatureThreshold) ? Long.fromValue(object.newSignatureThreshold) : Long.UZERO
    };
  },
  toJSON(message: SignatureThresholdUpdated): JsonSafe<SignatureThresholdUpdated> {
    const obj: any = {};
    message.oldSignatureThreshold !== undefined && (obj.oldSignatureThreshold = (message.oldSignatureThreshold || Long.UZERO).toString());
    message.newSignatureThreshold !== undefined && (obj.newSignatureThreshold = (message.newSignatureThreshold || Long.UZERO).toString());
    return obj;
  },
  fromPartial(object: Partial<SignatureThresholdUpdated>): SignatureThresholdUpdated {
    const message = createBaseSignatureThresholdUpdated();
    message.oldSignatureThreshold = object.oldSignatureThreshold !== undefined && object.oldSignatureThreshold !== null ? Long.fromValue(object.oldSignatureThreshold) : Long.UZERO;
    message.newSignatureThreshold = object.newSignatureThreshold !== undefined && object.newSignatureThreshold !== null ? Long.fromValue(object.newSignatureThreshold) : Long.UZERO;
    return message;
  },
  fromAmino(object: SignatureThresholdUpdatedAmino): SignatureThresholdUpdated {
    ...
    if (object.old_signature_threshold !== undefined && object.old_signature_threshold !== null) {
      message.oldSignatureThreshold = Long.fromString(object.old_signature_threshold);
    }
    if (object.new_signature_threshold !== undefined && object.new_signature_threshold !== null) {
      message.newSignatureThreshold = Long.fromString(object.new_signature_threshold);
    }
    return message;
  },
...
export const OwnershipTransferStarted = {
  typeUrl: "/circle.cctp.v1.OwnershipTransferStarted",
  encode(message: OwnershipTransferStarted, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.previousOwner !== "") {
      writer.uint32(10).string(message.previousOwner);
    }
    if (message.newOwner !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): OwnershipTransferStarted {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseMaxMessageBodySizeUpdated(): MaxMessageBodySizeUpdated {
  return {
    newMaxMessageBodySize: Long.UZERO
  };
}
export const MaxMessageBodySizeUpdated = {
  ...
  fromJSON(object: any): MaxMessageBodySizeUpdated {
    return {
      newMaxMessageBodySize: isSet(object.newMaxMessageBodySize) ? Long.fromValue(object.newMaxMessageBodySize) : Long.UZERO
    };
  },
  toJSON(message: MaxMessageBodySizeUpdated): JsonSafe<MaxMessageBodySizeUpdated> {
    const obj: any = {};
    message.newMaxMessageBodySize !== undefined && (obj.newMaxMessageBodySize = (message.newMaxMessageBodySize || Long.UZERO).toString());
    return obj;
  },
  fromPartial(object: Partial<MaxMessageBodySizeUpdated>): MaxMessageBodySizeUpdated {
    const message = createBaseMaxMessageBodySizeUpdated();
    message.newMaxMessageBodySize = object.newMaxMessageBodySize !== undefined && object.newMaxMessageBodySize !== null ? Long.fromValue(object.newMaxMessageBodySize) : Long.UZERO;
    return message;
  },
  fromAmino(object: MaxMessageBodySizeUpdatedAmino): MaxMessageBodySizeUpdated {
    ...
    if (object.new_max_message_body_size !== undefined && object.new_max_message_body_size !== null) {
      message.newMaxMessageBodySize = Long.fromString(object.new_max_message_body_size);
    }
    return message;
  },
...
export const SetBurnLimitPerMessage = {
  typeUrl: "/circle.cctp.v1.SetBurnLimitPerMessage",
  encode(message: SetBurnLimitPerMessage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.token !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SetBurnLimitPerMessage {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
